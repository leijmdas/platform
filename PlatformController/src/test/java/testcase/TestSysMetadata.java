...
//        req.cmdtype = "sysmetadata";
//        req.cmd = "updateDictById";
//        req.msgBody = JSONObject.parseObject("{\"token\":null,\"reqtime\":1536745347946,\"seqno\":1536745347946,\"cmdtype\":\"sysmetadata\",\"cmd\":\"makeTableByDictId\", \"msgBody\": \"{metadataId:45}\" }");
//
//        data = new Gson().toJson(req).toString();
//        System.out.println(data);
//        String ret = httpclient.post("http://localhost:8080/rest/sysmetadata", data, "application/json");
