...
public class TestTemplateExcelEasyPOIPlan {
    ...
    public void map_po() throws Exception {
        String f=PfContext.class.getResource("/templates/po_template.xlsx").getPath();
        TemplateExportParams params = new TemplateExportParams(
                "templates/po_template.xlsx");
         params = new TemplateExportParams(    f );
        Map<String, Object> map = new HashMap<String, Object>();
        Map <String, Object> info=new LinkedHashMap();
        map.put("info",info);
        info.put("tel","111");
    ...
    @Test
    public   void   testp(){
        String f=PfContext.class.getResource("/templates").getPath();
