...
import com.kunlong.platform.dubbo.api.transformer.SysHttpJobTransformer;
...
public class SysHttpJobApiProvider implements SysHttpJobApiService {
	...
	public PageResult<SysHttpJobDTO> query(SysHttpJobQueryDTO qpDTO) {
		com.kunlong.sys.domain.SysHttpJob.QueryParam qp = BeanMapper.getInstance().map(qpDTO, com.kunlong.sys.domain.SysHttpJob.QueryParam.class);
