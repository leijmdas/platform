...
import com.kunlong.platform.dubbo.api.transformer.SysJobGroupTransformer;
...
public class SysJobGroupApiProvider implements SysJobGroupApiService {
	...
	public PageResult<SysJobGroupDTO> query(SysJobGroupQueryDTO qpDTO) {
		com.kunlong.sys.domain.SysJobGroup.QueryParam qp = BeanMapper.getInstance().map(qpDTO, com.kunlong.sys.domain.SysJobGroup.QueryParam.class);
