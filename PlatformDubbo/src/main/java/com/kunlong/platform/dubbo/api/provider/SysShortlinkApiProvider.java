...
import com.kunlong.platform.dubbo.api.transformer.SysShortlinkTransformer;
...
public class SysShortlinkApiProvider implements SysShortlinkApiService {
	...
	public PageResult<SysShortlinkDTO> query(SysShortlinkQueryDTO qpDTO) {
		com.kunlong.sys.domain.SysShortlink.QueryParam qp = BeanMapper.getInstance().map(qpDTO, com.kunlong.sys.domain.SysShortlink.QueryParam.class);
