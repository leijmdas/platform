...
import com.kunlong.platform.dubbo.api.transformer.SysResourceGroupTransformer;
import com.kunlong.platform.dubbo.api.transformer.SysResourceTransformer;
...
public class SysResourceApiProvider implements SysResourceApiService {
	...
	public PageResult<SysResourceDTO> query(SysResourceQueryDTO qpDTO) {
		com.kunlong.sys.domain.SysResource.QueryParam qp = BeanMapper.getInstance().map(qpDTO, com.kunlong.sys.domain.SysResource.QueryParam.class);
