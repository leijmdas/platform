...
import com.kunlong.platform.dubbo.api.transformer.SysRoleTransformer;
...
public class SysRoleApiProvider implements SysRoleApiService {
	...
	public PageResult<SysRoleDTO> query(SysRoleQueryDTO qpDTO) {
		com.kunlong.sys.domain.SysRole.QueryParam qp = BeanMapper.getInstance().map(qpDTO, com.kunlong.sys.domain.SysRole.QueryParam.class);
